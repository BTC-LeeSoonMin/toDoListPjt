    ...
    const iconClickHendler = async (str, cNo) => {
        ...
        switch (str) {
            case ("insert"):
                ...
                await api.post("/api/card/insert",
                    JSON.stringify(msgData),
                )
                    .then(response => {
                        console.log("hle : " + response.data)
            ...
            case ("taskTogle"):
                ...
                await api.post("/api/card/getCntTask",
                    msgData,
                )
                    .then(response => {
                        setCntTask(response.data.getCnt_task)
            ...
            case ("pin"):
                ...
                await api.post("/api/card/card_pin",
                    msgData,
                )
                    .then(response => {
                        // console.log(response.data);
            ...
            case ("delete"):
                ...
                if (window.confirm("정말 삭제 하시겠습니까?")) {
                    await api.post("/api/card/card_delete",
                        msgData,
                    )
                        .then(response => {
                            console.log(response.data);
